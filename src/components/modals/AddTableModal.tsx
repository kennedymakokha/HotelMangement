...
interface props {
    show: boolean
    close(): void,
    changeNameinput(e: string): void
    changeCapacitynput(e: number): void
    submit(): void
    // data: ITableData
}

const AddTableModal = ({ show, close, changeCapacitynput,changeNameinput, submit }: props) => {
                                        ...
                                        <div className="h-28 mt-3">
                                            ...
                                            <div className=" ">
                                                ...
                                                <input
                                                    type="text"
                                                    name="capacity"
                                                    onChange={(e: ChangeEvent<HTMLInputElement>) => changeCapacitynput(Number(e.target.value))}
